...
- [Iranti](https://github.com/nfemmanuel/iranti) - Persistent shared memory for AI coding agents. Stores facts across sessions and tools (Claude Code, Codex CLI, GitHub Copilot) with semantic search and task checkpointing.
